...
import jpa.session.DeclaracionFacade;
...
public class DeclaracionController implements Serializable {
    ...
    private Declaracion current;
    private DataModel items = null;
    @EJB
    private jpa.session.DeclaracionFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Declaracion) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resource/Bundle").getString("DeclaracionCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resource/Bundle").getString("DeclaracionUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resource/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resource/Bundle").getString("DeclaracionDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resource/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Declaracion getDeclaracion(java.lang.Integer id) {
    ...
    public static class DeclaracionControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Declaracion) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Declaracion.class.getName());
            }
        }
